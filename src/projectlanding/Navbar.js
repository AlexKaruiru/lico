      ...
      >
        ...
        <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }}>
          <Text
            ...
            color='white'
          >
            <Button as={'a'} href="/" variant={'link'} color={'white'}>
              Lico
            </Button>
          </Text>
...
const DesktopNav = () => {
  const linkColor = ('gray.600', 'gray.200');
  const linkHoverColor = ('gray.800', 'white');
  const popoverContentBgColor = ('white', 'gray.800');
...
const MobileNav = () => {
  return (
    <Stack bg={('white', 'gray.800')} p={4} display={{ md: 'none' }}>
      {NAV_ITEMS.map((navItem) => (
